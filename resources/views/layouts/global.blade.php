...
<head>
	...
	<title>Bcrypt Password @yield("title")</title>
...
<body>
	<nav class="navbar navbar-expand p-0">
		<a class="navbar-brand text-center col-xs-12 col-md-3 col-lg-2 mr-0" href="index.html"> Bcrypt Password </a>
			...
			<div style="min-height: 100%" class="flex-row d-flex align-items-stretch m-0">
				<div class="polished-sidebar bg-light col-12 col-md-3 col-lg-2 p-0 collapse d-md-inline" id="sidebar-nav">
					<ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
						...
						<li>
							<a href="">
								<span class="oi oi-people"></span> Manage Clients
							</a>
						</li>
						<li>
							<a href="">
								<span class="oi oi-people"></span> Manage Operators
							</a>
						</li>
						<li>
							<a href="">
								<span class="oi oi-tag"></span> Manage Areas
							</a>
						</li>
						<li>
							<a href="">
								<span class="oi oi-tag"></span> Manage Packets
							</a>
						</li>
						<li>
							<a href="">
								<span class="oi oi-tag"></span> Manage Accounts
							</a>
						</li>
						<li>
							<a href="">
								<span class="oi oi-tag"></span> Manage Payments
							</a>
						</li>
